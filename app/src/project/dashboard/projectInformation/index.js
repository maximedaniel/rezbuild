  ...
  render() {
      ...
      if(this.state.project){
        ...
        <div className="row">
            ...
            <div id="general" className="col s12 white ">
            ...
            <div className="input-field col s12">
                <input  required id="degree"  ref="degree" type="number" defaultValue={this.state.project.degree} />
            ...
            <div id="needs" className="col s12  white ">
            <div className="input-field col s12">
            ...
            <div id="building" className="col s12  white ">
            <div className="input-field col s12">
            ...
            <div className="input-field col s12">
                <input  id="year" type="number"  ref="year"  defaultValue={this.state.project.year}/>
            ...
            <div id="geometry" className="col s12  white ">
            <div className="input-field col s12">
                <input  required id="floors"  ref="floors" type="number" defaultValue={this.state.project.floors} />
                <label  className="active" htmlFor="floors"> Number of floors (n°)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="interFloorHeight"  ref="interFloorHeight" type="number" defaultValue={this.state.project.interFloorHeight}/>
                <label  className="active" htmlFor="interFloorHeight"> Clear inter-floor height (m)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="floorNumber"  ref="floorNumber" type="number" defaultValue={this.state.project.floorNumber} />
                <label  className="active" htmlFor="floorNumber">Floor number (n°) (if apartment)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="apartmentByFloor"  ref="apartmentByFloor" type="number" defaultValue={this.state.project.apartmentByFloor}/>
                <label  className="active" htmlFor="apartmentByFloor">Number of apartments per floor (n°) (if apartment)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="totalFloorsBuilding"  ref="totalFloorsBuilding" type="number" defaultValue={this.state.project.totalFloorsBuilding}/>
                <label  className="active" htmlFor="totalFloorsBuilding">Total floors of the building (n°)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="footprintBuilding"  ref="footprintBuilding" type="number" defaultValue={this.state.project.footprintBuilding}/>
                <label  className="active" htmlFor="footprintBuilding">Net footprint of building (m²)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="totalUsefulSurface"  ref="totalUsefulSurface" type="number" defaultValue={this.state.project.totalUsefulSurface}/>
            ...
            <div className="input-field col s12">
                <input  required id="linearDimensionN"  ref="linearDimensionN" type="number" defaultValue={this.state.project.linearDimensionN}/>
                <label  className="active" htmlFor="linearDimensionN">N (m)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="linearDimensionNE"  ref="linearDimensionNE" type="number" defaultValue={this.state.project.linearDimensionNE}/>
                <label  className="active" htmlFor="linearDimensionNE">NE (m)</label>
            </div>

            <div className="input-field col s12">
                <input  required id="linearDimensionE"  ref="linearDimensionE" type="number" defaultValue={this.state.project.linearDimensionE}/>
                <label  className="active" htmlFor="linearDimensionE">E (m)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="linearDimensionSE"  ref="linearDimensionSE" type="number" defaultValue={this.state.project.linearDimensionSE}/>
                <label  className="active" htmlFor="linearDimensionSE">SE (m)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="linearDimensionS"  ref="linearDimensionS" type="number" defaultValue={this.state.project.linearDimensionS}/>
                <label  className="active" htmlFor="linearDimensionS">S (m)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="linearDimensionSW"  ref="linearDimensionSW" type="number" defaultValue={this.state.project.linearDimensionSW}/>
                <label  className="active" htmlFor="linearDimensionSW">SW (m)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="linearDimensionW"  ref="linearDimensionW" type="number" defaultValue={this.state.project.linearDimensionW}/>
                <label  className="active" htmlFor="linearDimensionW">W (m)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="linearDimensionNW"  ref="linearDimensionNW" type="number" defaultValue={this.state.project.linearDimensionNW}/>
            ...
            <div id="wrap" className="col s12  white ">
            <h6 className="grey-text">Number of windows wings</h6>
            <div className="input-field col s12">
                <input  required id="windowsN"  ref="windowsN" type="number" defaultValue={this.state.project.windowsN}/>
                <label  className="active" htmlFor="windowsN">N (n°)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="windowsNE"  ref="windowsNE" type="number" defaultValue={this.state.project.windowsNE}/>
                <label  className="active" htmlFor="windowsNE">NE (n°)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="windowsE"  ref="windowsE" type="number" defaultValue={this.state.project.windowsE}/>
                <label  className="active" htmlFor="windowsE">E (n°)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="windowsSE"  ref="windowsSE" type="number" defaultValue={this.state.project.windowsSE}/>
                <label  className="active" htmlFor="windowsSE">SE (n°)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="windowsS"  ref="windowsS" type="number" defaultValue={this.state.project.windowsS}/>
                <label  className="active" htmlFor="windowsS">S (n°)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="windowsSW"  ref="windowsSW" type="number" defaultValue={this.state.project.windowsSW}/>
                <label  className="active" htmlFor="windowsSW">SW (n°)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="windowsW"  ref="windowsW" type="number" defaultValue={this.state.project.windowsW}/>
                <label  className="active" htmlFor="windowsW">W (n°)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="windowsNW"  ref="windowsNW" type="number" defaultValue={this.state.project.windowsNW}/>
                <label  className="active" htmlFor="windowsNW">NW (n°)</label>
            </div>

            <h6 className="grey-text">Number of windows-door wings</h6>
            <div className="input-field col s12">
                <input  required id="windowsDoorN"  ref="windowsDoorN" type="number" defaultValue={this.state.project.windowsDoorN}/>
                <label  className="active" htmlFor="windowsDoorN">N (n°)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="windowsDoorNE"  ref="windowsDoorNE" type="number" defaultValue={this.state.project.windowsDoorNE}/>
                <label  className="active" htmlFor="windowsDoorNE">NE (n°)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="windowsDoorE"  ref="windowsDoorE" type="number" defaultValue={this.state.project.windowsDoorE}/>
                <label  className="active" htmlFor="windowsDoorE">E (n°)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="windowsDoorSE"  ref="windowsDoorSE" type="number" defaultValue={this.state.project.windowsDoorSE}/>
                <label  className="active" htmlFor="windowsDoorSE">SE (n°)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="windowsDoorS"  ref="windowsDoorS" type="number" defaultValue={this.state.project.windowsDoorS}/>
                <label  className="active" htmlFor="windowsDoorS">S (n°)</label>
            </div>
            <div className="input-field col s12">
                <input  required id="windowsDoorSW"  ref="windowsDoorSW" type="number" defaultValue={this.state.project.windowsDoorSW}/>
            ...
            <div className="input-field col s12">
                <input  required id="windowsDoorNW"  ref="windowsDoorNW" type="number" defaultValue={this.state.project.windowsDoorNW}/>
      ...
      return (
        <form className="col s12 white z-depth-1" onSubmit={this.submit} >
        {projectInformation}
